...
declare module 'vscode' {
  ...
  export interface TestProvider<T extends TestItem = TestItem> {
    ...
    provideWorkspaceTestHierarchy(
      ...
      token: CancellationToken
    ): ProviderResult<TestHierarchy<T>>
   ...
   */
  export interface TestRun<T extends TestItem = TestItem>
    extends TestRunOptions<T> {
    /**
