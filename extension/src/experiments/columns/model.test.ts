...
describe('ColumnsModel', () => {
  ...
  it('should return columns that equal the default columns fixture when given the default output fixture', async () => {
  ...
  it('should return expected columns that equal the deeply nested output fixture', async () => {
    const model = new ColumnsModel('', buildMockMemento())
    await model.transformAndSet(deeplyNestedOutput)
    expect(model.getSelected()).toStrictEqual(deeplyNestedColumns)
  })

  it('should return expected columns that equal the data types output fixture', async () => {
    const model = new ColumnsModel('', buildMockMemento())
